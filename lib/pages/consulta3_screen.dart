...
class Consulta3 extends StatefulWidget {
  const Consulta3({super.key});

  @override
  State<Consulta3> createState() => _Consulta3State();
}
...
class _Consulta3State extends State<Consulta3> {
  ...
  void initState() {
    ...
    controller
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) {
            if (request.url
                .startsWith('https://cadisdik.prodoc.id/konsultasi')) {
      ...
      ..loadRequest(
        Uri.parse('https://cadisdik.prodoc.id/konsultasi'),
      );
