...
class Consulta6 extends StatefulWidget {
  const Consulta6({super.key});

  @override
  State<Consulta6> createState() => _Consulta6State();
}

class _Consulta6State extends State<Consulta6> {
